...
public class  DataSource {
    ...
    public FlightSearch fetchFlights() throws Exception {
        ...
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 195, 6000.0,0.0));
        travelClasses.add(new TravelClass(ClassType.BUSINESS, 35, 13000.0,0.0));
        travelClasses.add(new TravelClass(ClassType.FIRST, 8, 20000.0,0.0));
        ...
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 144, 4000.0,0.0));
        ...
        travelClasses = new ArrayList<>();
        travelClasses.add(new TravelClass(ClassType.ECONOMY, 152, 5000.0,0.0));
        travelClasses.add(new TravelClass(ClassType.BUSINESS, 20, 10000.0,0.0));
